...
setup(
    ...
    package_data = {'passwdmanager':['icons/*.png','conf/*.conf','icons/*.ico','data/data.pmgr','backup/info.txt'] },
    data_files=[
#        ('icons',glob.glob("icons/*.*")),
#            ('data',glob.glob('data/*.pmgr')),
#            ('conf',glob.glob('conf/*.*')),
#            ('backup',['backup/info.txt']),
            ('/usr/share/applications',['passwdmanager/data/passwdManager.desktop']),
            ('/usr/share/pixmaps',['passwdmanager/icons/passwdManager.png']),
        ],
